...
train=read.csv("data/train_bike.csv")
View(train)
test=read.csv("data/test_bike.csv")
View(test)
str(train)
...
# Creating day part variable for registered users
data=rbind(train,test)
data$dp_reg=0
...
# Creating day part variable for casual users
data$dp_cas=0
...
# Creating temp part variable for registered users
data$temp_reg=0
...
# Creating temp part variable for casual users
data$temp_cas=0
...
# converting all relevant categorical variables into factors to feed our random forest model
data$season=as.factor(data$season)
data$holiday=as.factor(data$holiday)
data$workingday=as.factor(data$workingday)
data$weather=as.factor(data$weather)
